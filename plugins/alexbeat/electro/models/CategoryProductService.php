 ...
 * Model
 */
class CategoryProductService extends Model
{
     ...
     */
    public $table = 'alexbeat_electro_category_product_services';
    ...
    public $belongsTo = [
        'category' => ['Alexbeat\Electro\Models\Category', 'key' => 'category_id'],
